        ...
        <div className="relative border-l border-[#172033] ml-4 md:ml-32 space-y-10">
          {hackathonsData.map((item, idx) => (
            <div key={item.id} className="relative pl-6 md:pl-10 group">
              {/* Timeline Node Dot */}
              <div className="absolute -left-[9px] top-1.5 w-4 h-4 rounded-full bg-[#090d16] border-2 border-[#00f0ff] group-hover:scale-125 transition-transform shadow-[0_0_10px_rgba(0,240,255,0.4)] flex items-center justify-center">
              ...
              {/* Content Card */}
              <div className="p-6 rounded-2xl bg-[#090d16] border border-[#172033] group-hover:border-[#00f0ff]/40 transition-all duration-200">
