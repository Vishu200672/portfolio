          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 sm:p-8 rounded-2xl bg-[#090d16] border border-[#172033] space-y-6">
              ...
              <div className="p-4 rounded-xl bg-[#060910] border border-[#1e293b] space-y-2">
                ...
                {copied && (
                  <div className="text-[11px] font-mono text-[#10b981] flex items-center gap-1.5 pt-1">
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#060910] border border-[#1e293b] rounded-lg px-3.5 py-2.5 text-xs font-mono text-white focus:outline-none focus:border-[#00f0ff]"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#060910] border border-[#1e293b] rounded-lg px-3.5 py-2.5 text-xs font-mono text-white focus:outline-none focus:border-[#00f0ff] resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-[#00f0ff] text-[#05070b] font-mono text-xs font-bold shadow-[0_0_15px_-3px_rgba(0,240,255,0.4)] hover:bg-[#38bdf8] transition-all"
              >
              ...
              {sentStatus === "sent" && (
                <div className="p-3 rounded-lg bg-[#10b981]/10 border border-[#10b981]/30 text-xs font-mono text-[#10b981] flex items-center gap-2">
