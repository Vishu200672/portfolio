...
export default function InteractivePlayground() {
  ...
  const [pipelineStep, setPipelineStep] = useState(4); // 1 to 4
  ...
  // Heuristic calculation matching XGBoost & K-Means signals
  const calcChurnRisk = () => {
    // Higher recency = higher churn risk
    // Higher frequency & monetary = lower churn risk
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-4 mb-8 no-scrollbar">
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-lg text-xs font-mono font-medium transition-all shrink-0 ${
              activeTab === "smarthire"
          ...
          >
            ...
            <span>01. SMARTHIRE SEMANTIC SCORER</span>
          </button>
          ...
          >
            ...
            <span>02. CONVNEXT VISION PIPELINE</span>
          </button>
          ...
          >
            ...
            <span>03. CUSTOMER360 NBA ENGINE</span>
          </button>
        </div>

        {/* ======================================================== */}
        {/* PLAYGROUND 1: SMARTHIRE MATCHING SIMULATOR */}
        {/* ======================================================== */}
        {activeTab === "smarthire" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start animate-in fade-in duration-200">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="p-6 rounded-2xl bg-[#090d16] border border-[#172033] space-y-6">
                ...
                <div
                  className={`p-4 rounded-xl border ${currentTier.bg} ${currentTier.border}`}
                >
        ...
        {/* ======================================================== */}
        {/* PLAYGROUND 2: VISION PIPELINE EXPLORER */}
        {/* ======================================================== */}
        {activeTab === "vision" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start animate-in fade-in duration-200">
        ...
        {/* ======================================================== */}
        {/* PLAYGROUND 3: CUSTOMER360 NBA ENGINE */}
        {/* ======================================================== */}
        {activeTab === "customer360" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start animate-in fade-in duration-200">
            {/* Sliders */}
