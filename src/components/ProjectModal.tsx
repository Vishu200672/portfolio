      ...
      {project && (
        ...
        >
          ...
          >
            ...
            {/* Modal Scrollable Content with cross-fade */}
            <div className="p-6 overflow-y-auto space-y-6 flex-1 text-sm leading-relaxed text-[#cbd5e1] min-h-[300px]">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-1 gap-2.5">
                        {project.pipeline.map((step, idx) => (
                          <div
                            key={idx}
                            className="p-3.5 rounded-lg bg-[#070b12] border border-[#172033] flex items-start gap-4 hover:border-[#24324f] transition-colors"
                          >
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {project.metrics.map((metric, i) => (
                        <div
                          key={i}
                          className="p-5 rounded-xl bg-[#070b12] border border-[#172033] flex flex-col justify-between hover:border-[#24324f] transition-colors"
                        >
                          <div>
